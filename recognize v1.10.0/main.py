...
def navigate_wait(x=0, y=0, z=0, yaw=1.57, speed=0.5, frame_id='aruco_map', auto_arm=False, tolerance=0.2):
...
def main_flight(z=1.5):
    ...
    navigate(x=0, y=0, z=1.5, speed=0.5, frame_id='body', auto_arm=True, yaw=float('nan'))
    rospy.sleep(2)
    print("Took off")
